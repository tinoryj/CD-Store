    ...
    : AbsSecretSharing(n, k, r, cryptoUtil)
{
    ...
    r_ = r;
    if (cryptoUtil_ == NULL) {
        fprintf(stderr, "Error: no CryptoPrimitive instance for hash generation "
                        "and data encryption!\n");
        exit(1);
    }
